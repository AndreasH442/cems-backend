...
/** Only vendors actually integrated (docs/data-requirements.md, docs/data-requirements-open-meteo.md, docs/data-requirements-scholt.md) may appear here. */
export const CONNECTOR_VENDOR_TYPES = ["WENDEWARE", "OPEN_METEO", "SCHOLT"] as const;
